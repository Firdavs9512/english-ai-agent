...
def read_pdf_and_return_new_vocabulary(pdf_path: str) -> dict:
    """
...
def get_grammar_from_pdf(pdf_path: str) -> dict:
    """
...
def ai_create_grammar_lesson(grammar_info: dict) -> dict:
    """
...
if __name__ == "__main__":
    # vocabulary = read_pdf_and_return_new_vocabulary("extracted_pages_46_63.pdf")
    # print(json.dumps(vocabulary, indent=2, ensure_ascii=False))

    # grammar_info = get_grammar_from_pdf("extracted_pages_46_63.pdf")
    # print(json.dumps(grammar_info, indent=2, ensure_ascii=False))
    #     {
    #   "titles": [
    ...
    #     "Grammar - Quantifiers: some, any, no",
    #     "Language Use - have vs have got"
    #   ],
    #   "thread_id": "chatcmpl-Awaa9zqBzIqtPN2XdjpxIAfpU8LqA"
    # }

    # Test grammar lesson creation
    grammar_topic = {"title": "Grammar - Countable Nouns", "thread_id": "chat_abc123"}
    lesson = ai_create_grammar_lesson(grammar_topic)
